  ...
  return (
    <>
      ...
      <Sidebar variant="floating" {...props}>
        ...
        <SidebarHeader className="sidebar-glass-header pb-1">
          <SidebarMenu>
            <SidebarMenuItem>
              <DropdownMenu open={isWorkspaceDropdownOpen} onOpenChange={setIsWorkspaceDropdownOpen}>
                <DropdownMenuTrigger asChild>
                  <SidebarMenuButton size="lg" className="sidebar-workspace-btn group/ws">
                    <div className={`flex h-8 w-8 items-center justify-center rounded-md ${activeDropdownOption.color} text-white text-sm font-bold shrink-0 shadow-sm`}>
                    ...
                    <ChevronsUpDown className="ml-auto size-4 text-muted-foreground/70 shrink-0 transition-transform group-data-[state=open]/ws:rotate-180" />
                  </SidebarMenuButton>
                </DropdownMenuTrigger>

                <DropdownMenuContent
                  className="w-[var(--radix-dropdown-menu-trigger-width)] min-w-[var(--radix-dropdown-menu-trigger-width)] sidebar-glass-dropdown rounded-xl border border-white/20 bg-[hsl(var(--popover)/0.72)] shadow-[0_18px_48px_rgba(0,0,0,0.16)] backdrop-blur-2xl"
                  align="start"
                  sideOffset={6}
                >
        ...
        {/* ── Footer — theme toggle ─────────────────────────── */}
        <SidebarFooter className="sidebar-glass-footer pt-1">
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                onClick={toggleMode}
