      ...
      >
        <div
          ...
          className={cn(
            ...
            variant === "floating"
              ? "sidebar-glass rounded-[18px]"
              : "bg-[hsl(var(--sidebar)/0.88)] supports-[backdrop-filter]:bg-[hsl(var(--sidebar)/0.72)] backdrop-blur-xl group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:shadow-sm",
            innerClassName
          )}
          style={innerStyle}
        >
